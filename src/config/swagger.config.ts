...
const swaggerDefinition: swaggerJsdoc.OAS3Definition = {
  ...
  info: {
    ...
    description:
      "REST API documentation for the Golf service platform. All endpoints follow REST best practices, use JSON payloads, and require HTTPS.",
    version: "1.0.0",
    contact: {
      name: "Golf Support",
      email: "support@golf.com",
    },
    security: [
      {
        BearerAuth: [],
      ...
      AuthRegisterRequest: {
        ...
        properties: {
          email: {
            type: "string",
            format: "email",
            example: "golfer@golf.com",
          },
          password: { type: "string", minLength: 8, example: "StrongP@ssw0rd" },
          fullName: { type: "string", example: "Jordan Golfer" },
        },
      },
